...
bulk = [polarized_site for _ in range(P)]
...
checkpoint_folder = f"xx_yy_dissipation={dissipation_strength}_J={J}_L={L}"
...
ani = animation.FuncAnimation(fig, animate, frames=number_of_slices, interval=500)
plt.show()
